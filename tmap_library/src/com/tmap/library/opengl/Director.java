package com.tmap.library.opengl;

import static com.tmap.library.opengl.Constant.TEX_PER_METER;
...
public class Director implements Geometry{
    ...
    public Director(float x1, float y1, float z1, float x2, float y2, float z2, int texId)
    {
